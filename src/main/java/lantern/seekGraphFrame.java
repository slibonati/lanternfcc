...
//JFrame mytempframe = new JFrame();
		...
		myseeker.setLocation(mymultiframe.getLocation().x + mymultiframe.getSize().width / 2 - defaultWidth / 2,
				mymultiframe.getLocation().y + mymultiframe.getSize().height / 2 - defaultHeight / 2);
...
//myconsolepanel.Input.setFocusable(false);
	 ...
	 * myconsolepanel.Input.setRequestFocusEnabled(true); //Input.requestFocus();
