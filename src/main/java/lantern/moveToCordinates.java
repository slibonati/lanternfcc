...
class moveToCordinates {
	/*
	 * int getxmove(String amove, int toggle, int iflipped, int turn) amove: the 4
	 * digit algabraic move toggle: 0 or 2 is it reading the first 2 chars or second
	 * two chars iflipped: 1 or 0. if 1 returns 7- value turn: used in crazyhouse to
	 * detect if looking for upper or lower case feed it 0 if not crazyhouse it wont
	 * matter returns: collumn number 0-7 and as mentinoed inverted if iflipped 1
	 * 
	...
	/*
	 * int getymove(String amove, int toggle) amove: the 4 digit algabraic move
	 * toggle: 0 or 2 is it reading the first 2 chars or second two chars returns:
	 * the row 0-7 or 0 if an error
	 */
