...
class CorrespondenceMoveDialog extends JDialog {
	...
	void initComponents() {
		...
		textView.setText(
				"Type the move in standard notation such as e4 or Nf3. A confirmation board will popup up showing the candiate move and a dialog to choose yes make move or no.");
	...
	void setLayout() {
		...
		hRowBottom.addComponent(input, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, 250);
		hRowBottom.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED);
		hRowBottom.addComponent(send, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE);
		hRowBottom.addComponent(playingLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE);
		h1.addGroup(hRowTop);
		h1.addComponent(textView, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
		h1.addComponent(textLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
		...
		vRowBottom.addComponent(input, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE);
		vRowBottom.addComponent(send, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE);
		vRowBottom.addComponent(playingLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE);

		vGroup.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED);
		vGroup.addGroup(vRowTop);
		vGroup.addComponent(textView, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
		vGroup.addComponent(textLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE);
		vGroup.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED);
