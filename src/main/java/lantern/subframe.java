...
class subframe extends JInternalFrame implements ComponentListener, InternalFrameListener, ActionListener {
	// ActionListener,
	...
	subframe(channels sharedVariables1, JTextPane[] consoles1, ConcurrentLinkedQueue<myoutput> queue1,
		...
		/*
		 * JMenu consoleMenu = new JMenu("Colors/fonts per console"); JMenuItem setfont
		 * = new JMenuItem("Console's Font"); consoleMenu.add(setfont);
		 * JCheckBoxMenuItem overridefont = new
		 * JCheckBoxMenuItem("Console Font Override Tab Font");
		 * consoleMenu.add(overridefont); setfont.addActionListener(new ActionListener()
		 * { public void actionPerformed(ActionEvent e) { setConsoleFont(); } });
		 * overridefont.addActionListener(new ActionListener() { public void
		 * actionPerformed(ActionEvent e) { if
		 * (sharedVariables.useConsoleFont[consoleNumber]==true)
		 * sharedVariables.useConsoleFont[consoleNumber]=false; else
		 * sharedVariables.useConsoleFont[consoleNumber]=true; } }); JMenuBar
		 * myconsolemenu = new JMenuBar();
		 * 
		 * myconsolemenu.add(consoleMenu); setJMenuBar(myconsolemenu);
		 */
		...
		/*
		 * JMenuItem item3 = new JMenuItem("Hyperlink"); item3.addActionListener(new
		 * ActionListener() { public void actionPerformed(ActionEvent e) { try { String
		 * myurl =""; myurl=consoles[consoleNumber].getSelectedText();
		 * myurl=myurl.trim(); String myurl2 = myurl.toLowerCase(); int go=0; if
		 * (myurl2.startsWith("www.")) go=1; if (myurl2.startsWith("http://")) go=1; if
		 * (myurl2.startsWith("https://")) go=1; if (go == 0) return;
		 * sharedVariables.openUrl(myurl);
		 * 
		 * giveFocus(); } catch (Exception g) {} } }); menu.add(item3);
		 */
		...
		/*
		 * JMenuItem item3 = new JMenuItem("copy"); item.addActionListener(new
		 * ActionListener() { public void actionPerformed(ActionEvent e) {
		 * consoles[consoleNumber].copy();} }); menu.add(item3);
		 */
		...
		// add accelerators
		telltab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, ActionEvent.CTRL_MASK));
		telltab2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M, ActionEvent.CTRL_MASK));
		if (isMac) {
			incfont.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_I, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
			decfont.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_D, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
		} else {
			incfont.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_UP, ActionEvent.ALT_MASK));
			decfont.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, ActionEvent.ALT_MASK));
		}

		if (isMac) {
			incfont2.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_I, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
			decfont2.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_D, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
		} else {
			incfont2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_UP, ActionEvent.ALT_MASK));
			decfont2.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_DOWN, ActionEvent.ALT_MASK));
		}
		...
		// add accelerators
		buttonlist[1].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_1, ActionEvent.CTRL_MASK));
		buttonlist[2].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_2, ActionEvent.CTRL_MASK));
		buttonlist[3].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_3, ActionEvent.CTRL_MASK));
		buttonlist[4].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_4, ActionEvent.CTRL_MASK));
		buttonlist[5].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_5, ActionEvent.CTRL_MASK));
		buttonlist[6].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_6, ActionEvent.CTRL_MASK));
		buttonlist[7].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_7, ActionEvent.CTRL_MASK));
		buttonlist[8].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_8, ActionEvent.CTRL_MASK));
		buttonlist[9].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_9, ActionEvent.CTRL_MASK));
		buttonlist[0].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_0, ActionEvent.CTRL_MASK));
		...
		// add accelerators
		nextconsole.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_T, ActionEvent.CTRL_MASK));
		nextchat.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Z, ActionEvent.CTRL_MASK));
		if (isMac) {
			nexttab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, ActionEvent.CTRL_MASK));
			prevtab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.CTRL_MASK));
		} else {
			nexttab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_RIGHT, ActionEvent.ALT_MASK));
			prevtab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_LEFT, ActionEvent.ALT_MASK));
		}
		tabarray[0].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_1, ActionEvent.ALT_MASK));
		tabarray[1].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_2, ActionEvent.ALT_MASK));
		tabarray[2].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_3, ActionEvent.ALT_MASK));
		tabarray[3].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_4, ActionEvent.ALT_MASK));
		tabarray[4].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_5, ActionEvent.ALT_MASK));
		tabarray[5].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_6, ActionEvent.ALT_MASK));
		tabarray[6].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_7, ActionEvent.ALT_MASK));
		tabarray[7].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_8, ActionEvent.ALT_MASK));
		tabarray[8].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_9, ActionEvent.ALT_MASK));
		tabarray[9].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_0, ActionEvent.ALT_MASK));
		tabarray[10].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, ActionEvent.ALT_MASK));
		tabarray[11].setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, ActionEvent.ALT_MASK));
		if (isMac) {
			showboard.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_B, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
			nextbtab.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_R, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
			prevbtab.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_L, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
			closebtab.setAccelerator(
					KeyStroke.getKeyStroke(KeyEvent.VK_K, Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
		} else {
			showboard.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_B, ActionEvent.ALT_MASK));
			nextbtab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_R, ActionEvent.ALT_MASK));
			prevbtab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_L, ActionEvent.ALT_MASK));
			closebtab.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_X, ActionEvent.ALT_MASK));
		}
		prevmoves.setAccelerator(
				KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, ActionEvent.CTRL_MASK | ActionEvent.SHIFT_MASK));
		prevmove.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_MINUS, ActionEvent.CTRL_MASK));
		nextmove.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, ActionEvent.CTRL_MASK));
		nextmoves.setAccelerator(
				KeyStroke.getKeyStroke(KeyEvent.VK_EQUALS, ActionEvent.CTRL_MASK | ActionEvent.SHIFT_MASK));
	...
	public void actionPerformed(ActionEvent event) {
		...
		try {
			...
			if (action.equals("Show Channel Names List")) {
				...
				String mess2 = sharedVariables.getChannelNotifyOnline() + sharedVariables.getConnectNotifyOnline();
				writeToConsole(mess2, sharedVariables.responseColor, false, null);

			} else if (action.equals("Increase font size") || action.equals("Decrease font size")) {
			...
			} else if (action.equals("Next tab") || action.equals("Previous tab")) {
				boolean nextprev = action.equals("Next tab");
				int mct = sharedVariables.maxConsoleTabs;
				int con = (sharedVariables.looking[consoleNumber] + (nextprev ? 1 : mct - 1)) % mct;
			...
			} else if (action.equals("Next board tab") || action.equals("Previous board tab")) {
				boolean nextprev = action.equals("Next board tab");
				int games = getActiveGame();
				if (games > -1) {
					myboards[games].myconsolepanel.makehappen(myboards[games].myconsolepanel.getNextGame(nextprev));
					giveFocus();
				}
			...
			} else if (action.equals("Move to start of game") || action.equals("Previous move")
					|| action.equals("Next move") || action.equals("Move to end of game")) {
				int games = getActiveGame();
				if (games > -1) {
	...
	void setTabColors(int con) {
		JDesktopPaneCustom myself = (JDesktopPaneCustom) getDesktopPane();
		customizeTabConsolelColorsDialog frame = new customizeTabConsolelColorsDialog((JFrame) myself.myframe, false,
				sharedVariables, consoles, con, this);
	...
	void customizeTabQtells(int num) {
		JDesktopPaneCustom myself = (JDesktopPaneCustom) getDesktopPane();
		customizeChannelQtellsDialog frame = new customizeChannelQtellsDialog((JFrame) myself.myframe, false,
				sharedVariables, num);
		frame.setLocation(getPopupX() - frame.getWidth() / 2, getPopupY() - frame.getHeight() / 2);
		frame.setVisible(true);
	}
	...
	void customizeTab(int num) {
		JDesktopPaneCustom myself = (JDesktopPaneCustom) getDesktopPane();
		customizeChannelsDialog frame = new customizeChannelsDialog((JFrame) myself.myframe, false, num,
				sharedVariables, myself.consoleSubframes);
	...
	private void initComponents() {
		...
		consoles[consoleNumber].addMouseListener(new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				...
				try {
					...
					if (e.getButton() == MouseEvent.BUTTON3 || (e.getClickCount() == 2 && sharedVariables.autopopup)) {
			 ...
			 * (consoles[consoleNumber].getSelectedText().indexOf(" ") == -1)
			 * menu3.show(e.getComponent(),e.getX(),e.getY()); else
			 * menu.show(e.getComponent(),e.getX(),e.getY()); }
			 */
				...
				if (!editor.isEditable()) {
					...
					if (pos >= 0) {
						...
						if (at.containsAttributes(attrs)) {
							...
							/*
							 * if (myurl2.startsWith("observe")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("finger")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("help")) { dispatchCommand(myurl);
							 * 
							 * } else if(myurl2.startsWith("accept")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("decline")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("match")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("examine")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("follow")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("play")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("games")) { dispatchCommand(myurl);
							 * 
							 * } else if (myurl2.startsWith("liblist")) { dispatchCommand(myurl);
							 */
							if (myurl2.startsWith("observe") || myurl2.startsWith("finger") || myurl2.startsWith("help")
									|| myurl2.startsWith("accept") || myurl2.startsWith("decline")
									|| myurl2.startsWith("match") || myurl2.startsWith("examine")
									|| myurl2.startsWith("follow") || myurl2.startsWith("play")
									|| myurl2.startsWith("games") || myurl2.startsWith("liblist")) {
		...
		scrollbutton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				/*
				 * JFrame aframe = new JFrame(); int d =
				 * consoles[consoleNumber].getScrollableBlockIncrement(consoles[consoleNumber].
				 * getVisibleRect(), SwingConstants.VERTICAL, -1); int f =
				 * sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
				 * getValue(); int g =
				 * sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
				 * getMaximum(); aframe.setTitle(" current value" + f + " and maximum " + g +
				 * " and block inc is "+ d); aframe.setVisible(true);
				 */
			}
		});
		...
		consoles[consoleNumber].addMouseWheelListener(new MouseWheelListener() {
			// sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().addMouseWheelListener(new
			// MouseWheelListener()
			public void mouseWheelMoved(MouseWheelEvent e) {
				...
				if (e.getScrollType() == MouseWheelEvent.WHEEL_UNIT_SCROLL) {
					/*
					 * message += "    Scroll type: WHEEL_UNIT_SCROLL" + newline; message +=
					 ...
					 * sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
					 * getUnitIncrement(1) + " pixels" + newline;
					 */

					if (notches < 0) {
						sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().setValue(
								sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().getValue()
										- (e.getScrollAmount() * mult));
						scrollnow = 0;
						wheelIsScrolling = true;
						...
						int myvalue = 100 + d;
						if (sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().getValue()
								+ myvalue > sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar()
										.getMaximum()) {
							wheelIsScrolling = false;
							scrollnow = 1;
							sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar()
									.setValue(sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar()
											.getMaximum());
					...
					/*
					 * message += "    Scroll type: WHEEL_BLOCK_SCROLL" + newline; message +=
					 * "    Vertical block increment: " +
					 * sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
					 * getBlockIncrement(1) + " pixels" + newline;
					 */
					scrollnow = 0;
					wheelIsScrolling = true;

					int block = sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar()
							.getBlockIncrement(1) * mult;
					if (notches < 0) {
						sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().setValue(
								sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().getValue()
										- block);
		...
		sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar()
				.addAdjustmentListener(new AdjustmentListener() {
					public void adjustmentValueChanged(AdjustmentEvent e) {
						 ...
						 * int dd =
						 * consoles[consoleNumber].getScrollableBlockIncrement(consoles[consoleNumber].
						 * getVisibleRect(), SwingConstants.VERTICAL, -1); z = z+dd; z *= -1;
						 * 
						 * if (z == blockInc) { //JFrame fri = new JFrame("z is " + z + " and dd is " +
						 * dd); //fri.setVisible(true); wheelIsScrolling = true; scrollnow = 0; return;
						 * }
						 */

						if (scrollnow == 1 && !sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar()
								.getValueIsAdjusting()) {
							e.getAdjustable().setValue(e.getAdjustable().getMaximum());
							// end if not adjusting
						} else {
							if (sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar()
									.getValueIsAdjusting())
								scrollnow = 0;

							int d = consoles[consoleNumber].getScrollableBlockIncrement(
									consoles[consoleNumber].getVisibleRect(), SwingConstants.VERTICAL, -1);
							int myvalue = 60 + d;
							try {
								if (sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().getValue()
										+ myvalue > sharedVariables.ConsoleScrollPane[consoleNumber]
												.getVerticalScrollBar().getMaximum())
									scrollnow = 1;

								if (scrollnow == 1 && !sharedVariables.ConsoleScrollPane[consoleNumber]
		...
		/*
		 * for (int a=0; a<10; a++) channelTabs[a].setForeground(lc);
		 */
	 ...
	 * 
	 * public void mouseExited(MouseEvent me) {} public void mouseClicked(MouseEvent
	 * me) {
	 * 
	 * }
	 */
	...
	void setupMenu(final String handle) {
		...
		if (sharedVariables.rightClickMenu.size() > 0) {
			...
			for (int m = 0; m < sharedVariables.rightClickMenu.size() - removal; m++) {
				...
				final int mfinal = m;
				items[m] = sharedVariables.rightClickMenu.get(m).equals("Finger r")
						? new JMenuItem("Finger " + handle + " r")
						: new JMenuItem("" + sharedVariables.rightClickMenu.get(m) + " " + handle);
				...
				items[m].addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						if (sharedVariables.rightClickMenu.get(mfinal).equals("Tell")) {
							...
							JDesktopPaneCustom myself = (JDesktopPaneCustom) getDesktopPane();
							customizeChannelNotifyDialog frame = new customizeChannelNotifyDialog(
									(JFrame) myself.myframe, false, sharedVariables, handle);
							frame.setVisible(true);
							...
							for (int i = 0; i < sharedVariables.toldTabNames.size(); i++) {
								if (sharedVariables.toldTabNames.get(i).name.toLowerCase()
							...
							tellMasterDialog frame = new tellMasterDialog((JFrame) myself.myframe, false,
									sharedVariables, theName, soundof, channelof);

							/*
							 * boolean found = false; for (int i=0; i< sharedVariables.toldTabNames.size();
							 * i++) { if (sharedVariables.toldTabNames.get(i).name.equals(handle)) {
							 * sharedVariables.toldTabNames.get(i).tab =
							 * sharedVariables.looking[consoleNumber];
							 * 
							 * found = true; break; } }// end for
							 * 
							 * if(!found) { told him = new told(); him.name = handle; him.tab =
							 * sharedVariables.looking[consoleNumber];
	...
	public JMenu makerightclickhappen(MouseEvent e, final int n, final boolean mypopup) {
		...
		item5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				 * if (sharedVariables.tabStuff[n].typed) { sharedVariables.tabStuff[n].typed =
				 * false; item5.setSelected(false); } else { sharedVariables.tabStuff[n].typed =
				 * true; item5.setSelected(true); }
				 */
				if (mypopup == true) {
		...
		/*
		 * if (sharedVariables.tabStuff[n].typed) item5.setSelected(true); else
		...
		item6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				/*
				 * if (!sharedVariables.tabStuff[n].told) { sharedVariables.tabStuff[n].told =
				 * true; item6.setSelected(true); } else { sharedVariables.tabStuff[n].told =
				 * false; item6.setSelected(false); }
				 */
				if (mypopup == true) {
		...
		/*
		 * if (!sharedVariables.tabStuff[n].told) item6.setSelected(true); else
		...
		else if (sharedVariables.tellsToTab && sharedVariables.tellTab == sharedVariables.looking[consoleNumber]
				&& mypopup == false)
			item7.setSelected(true);
	...
	void doToolBarCommand(int n) {
		...
		if (sharedVariables.tabStuff[sharedVariables.looking[consoleNumber]].typedColor == null)
			...
			StyleConstants.setForeground(attrs,
					sharedVariables.tabStuff[sharedVariables.looking[consoleNumber]].typedColor);
		try {
	...
	void updateComboBox(int n) {
		...
		// aaframe.setTitle(comboMemory[n] + " is combo memory, in update combo box and
		// n is " + n);
	...
	void addNameToCombo(String name) {
		try {
			for (int z = 0; z < sharedVariables.comboNames[sharedVariables.looking[consoleNumber]].size(); z++)
				if (sharedVariables.comboNames[sharedVariables.looking[consoleNumber]].get(z).equals(name)) { // set
																												// selected
	...
	public void internalFrameClosing(InternalFrameEvent e) {
		...
		if (consoleNumber == 0) {
			try {
				// mymultiframe frame =
				// (mymultiframe)getRootPane().getParent().getParent().getParent().getParent().getParent().getParent();
			...
			public void run() {
				try {
					...
					if (sharedVariables.operatingSystem.equals("mac")) {
						...
						if (!current.equals("") && current.charAt(current.length() - 1) != ' ')
	...
	void writeToConsole(String mes, Color col, boolean italic, SimpleAttributeSet attrs) {
		try {
			...
			printOut.processLink(doc, mes, col, sharedVariables.looking[consoleNumber], maxLinks, SUBFRAME_CONSOLES,
					attrs, null);
			queue.add(printOut);
	...
	class subPanel extends JPanel {
		...
		subPanel() {
			...
			Input.addKeyListener(new KeyListener() {
				public void keyPressed(KeyEvent e) {
					...
					/*
					 * //if (e.getModifiersEx() == 128 || e.getModifiersEx() == 192) if ((gme &
					 * InputEvent.CTRL_DOWN_MASK) != 0) { //int moveKeyType = gme; //if (a == 61) {
					 * if (a == KeyEvent.VK_EQUALS) { int games = getActiveGame(); if (games > -1) {
					 * int loc = sharedVariables.moveSliders[games].getValue(); int max =
					 * sharedVariables.moveSliders[games].getMaximum(); //if (loc < max ||
					 * moveKeyType == 192) { if (loc < max || (gme & InputEvent.SHIFT_DOWN_MASK) !=
					 * 0) { //if (moveKeyType == 192) if ((gme & InputEvent.SHIFT_DOWN_MASK) != 0)
					 * loc = max; else loc++;
					 * 
					 * sharedVariables.moveSliders[games].setValue(loc);
					 * myboards[games].mycontrolspanel.adjustMoveList(); myboards[games].repaint();
					 * } giveFocus(); }
					 * 
					 * return; }
					 * 
					 * //if (a == 45) { if (a == KeyEvent.VK_MINUS) { int games = getActiveGame();
					 * if (games > -1) { int loc = sharedVariables.moveSliders[games].getValue();
					 * 
					 * //if (loc > 0 || moveKeyType == 192) { if (loc > 0 || (gme &
					 * InputEvent.SHIFT_DOWN_MASK) != 0) { //if (moveKeyType == 192) if ((gme &
					 * InputEvent.SHIFT_DOWN_MASK) != 0) loc = 0; else loc--;
					 * 
					 * sharedVariables.moveSliders[games].setValue(loc);
					 * myboards[games].mycontrolspanel.adjustMoveList(); myboards[games].repaint();
					 * } giveFocus(); }
					 * 
					 * return; } }// if control or control + shift
					 */
					...
					if (gme == InputEvent.CTRL_DOWN_MASK) {
						...
						// if (a == 71) {
						/*
						 * if (a == KeyEvent.VK_G) { String myurl = Input.getText(); Input.setText("");
						 * 
						 * myurl = myurl.trim(); myurl = myurl.replace(" ", "+");
						 * 
						 * sharedVariables.openUrl("http://www.google.com/search?q=" + myurl); }
						 */
						...
						if (a == KeyEvent.VK_H) {
							...
							if (sharedVariables.myGameList != null && sharedVariables.myGameList.isVisible()) {
								try {
						...
						/*
						 * //if (a == 77) { if (a == KeyEvent.VK_M) { sharedVariables.tellsToTab = true;
						 * sharedVariables.tellTab = sharedVariables.looking[consoleNumber]; myoutput
						 * data = new myoutput(); data.repaintTabBorders = 1; queue.add(data);
						 * 
						 * return; }
						 * 
						 * //if (a == 90) { if (a == KeyEvent.VK_Z) { switchConsoleWindows(); return; }
						 * 
						 * //if (a == 84) { if (a == KeyEvent.VK_T) { switchWindows(); return; }
						 * 
						 * //if (a == 49) { if (a == KeyEvent.VK_1) { doToolBarCommand(1); return; }
						 * //if (a == 50) { if (a == KeyEvent.VK_2) { doToolBarCommand(2); return; }
						 * //if (a == 51) { if (a == KeyEvent.VK_3) { doToolBarCommand(3); return; }
						 * //if (a == 52) { if (a == KeyEvent.VK_4) { doToolBarCommand(4); return; }
						 * //if (a == 53) { if (a == KeyEvent.VK_5) { doToolBarCommand(5); return; }
						 * //if (a == 54) { if (a == KeyEvent.VK_6) { doToolBarCommand(6); return; }
						 * //if (a == 55) { if (a == KeyEvent.VK_7) { doToolBarCommand(7); return; }
						 * //if (a == 56) { if (a == KeyEvent.VK_8) { doToolBarCommand(8); return; }
						 * //if (a == 57) { if (a == KeyEvent.VK_9) { doToolBarCommand(9); return; }
						 * //if (a == 48) { if (a == KeyEvent.VK_0) { doToolBarCommand(0); return; }
						 * 
						 * //if (a == 68) { if (a == KeyEvent.VK_D) { String mess2 =
						 * sharedVariables.getChannelNotifyOnline(); mess2 +=
						 * sharedVariables.getConnectNotifyOnline(); writeToConsole(mess2,
						 * sharedVariables.responseColor, false); // false for not italic return; }
						 */
					}

					/*
					 * //if (e.getModifiersEx() == 512) { if (gme == InputEvent.ALT_DOWN_MASK &&
					 * //if (a == 84) { a == KeyEvent.VK_T) { changeTellTab(true); // true for
					 * forward }
					 * 
					 * //if (e.getModifiersEx() == 576) { if (gme == InputEvent.ALT_DOWN_MASK |
					 * InputEvent.SHIFT_DOWN_MASK && //if (a == 84) { a == KeyEvent.VK_T) {
					...
					if (gme == InputEvent.ALT_DOWN_MASK) {
						...
						if (a == KeyEvent.VK_BACK_QUOTE) {
							 ...
							 * sharedVariables.activitiesNeverOpen = false; String mess2 =
							 * "Activities window enabled to open at login if " +
							 * "you leave it open on close and save settings. " +
							 * "Do 'save settings' to save this change.\n"; writeToConsole(mess2,
							 * sharedVariables.responseColor, false); } else {
							 * sharedVariables.activitiesNeverOpen = true; String mess2 =
							 * "Activities window disabled to open at login if " +
							 * "you leave it open on close and save settings. " +
							 * "Do 'save settings' to save this change.\n"; writeToConsole(mess2,
							 * sharedVariables.responseColor, false); }
							 */
							sharedVariables.activitiesNeverOpen = !sharedVariables.activitiesNeverOpen;
						...
						/*
						 * //if (a == 82) {// switch to right board tab if (a == KeyEvent.VK_R) { int
						 * games = getActiveGame(); if (games > -1) {
						 * myboards[games].myconsolepanel.makehappen(myboards[games].myconsolepanel.
						 * getNextGame(true)); giveFocus(); } return; }
						 * 
						 * //if (a == 76) {// switch to left board tab if (a == KeyEvent.VK_L) { int
						 * games = getActiveGame(); if (games > -1) {
						 * myboards[games].myconsolepanel.makehappen(myboards[games].myconsolepanel.
						 * getNextGame(false)); giveFocus(); } return; }
						 * 
						 * //if (a == 66) {// bring up board if (a == KeyEvent.VK_B) {
						 * 
						 * int games = getActiveGame();
						 * 
						 * if (games > -1) { myboards[games].setSelected(true); giveFocus(); } return; }
						 * 
						 * //if (a == 88) {// x close active game tab (first board) if (a ==
						 * KeyEvent.VK_X) { int games = getActiveGame();
						 * 
						 * if (games > -1) { myoutput data = new myoutput(); data.closetab =
						 * myboards[games].myconsolepanel.getPhysicalTab(myboards[games].gameData.
						 * LookingAt);
						 * 
						 * data.focusConsole = consoleNumber;
						 * 
						 * queue.add(data); } return; }
						 */
					...
					if (gme == InputEvent.ALT_DOWN_MASK) {
						/*
						 * //if (a == 49) { if (a == KeyEvent.VK_1) {
						 * //sharedVariables.looking[consoleNumber]=0; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(0); makeHappen(0); } //if (a == 50) { if (a ==
						 * KeyEvent.VK_2) { //sharedVariables.looking[consoleNumber]=1; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(1); makeHappen(1); } //if (a == 51) { if (a ==
						 * KeyEvent.VK_3) { //sharedVariables.looking[consoleNumber]=2; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(2); makeHappen(2); } //if (a == 52) { if (a ==
						 * KeyEvent.VK_4) { //sharedVariables.looking[consoleNumber]=3; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(3); makeHappen(3); } //if (a == 53) { if (a ==
						 * KeyEvent.VK_5) { //sharedVariables.looking[consoleNumber]=4; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(4); makeHappen(4); } //if (a == 54) { if (a ==
						 * KeyEvent.VK_6) { //sharedVariables.looking[consoleNumber]=5; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(5); makeHappen(5); } //if (a == 55) { if (a ==
						 * KeyEvent.VK_7) { //sharedVariables.looking[consoleNumber]=6; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(6); makeHappen(6); } //if (a == 56) { if (a ==
						 * KeyEvent.VK_8) { //sharedVariables.looking[consoleNumber]=7; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(7); makeHappen(7); } //if (a == 57) { if (a ==
						 * KeyEvent.VK_9) { //sharedVariables.looking[consoleNumber]=8; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(8); makeHappen(8); }
						 * 
						 * //if (a == 48) { if (a == KeyEvent.VK_0) {
						 * //sharedVariables.looking[consoleNumber]=9; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(9); makeHappen(9); } //if (a == 45) { if (a ==
						 * KeyEvent.VK_MINUS) { //sharedVariables.looking[consoleNumber]=10; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(10); makeHappen(10); } //if (a == 61) { if (a ==
						 * KeyEvent.VK_EQUALS) { //sharedVariables.looking[consoleNumber]=11; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3)
						 * tabChooser.setSelectedIndex(11); makeHappen(11); }
						 * 
						 * //if (a == 38) { if (a == KeyEvent.VK_UP) { int con =
						 * sharedVariables.looking[consoleNumber];
						 * 
						 * if (sharedVariables.tabStuff[con].tabFont != null) { float fontsize = (float)
						 * sharedVariables.tabStuff[con].tabFont.getSize(); fontsize++;
						 * sharedVariables.tabStuff[con].tabFont =
						 * sharedVariables.tabStuff[con].tabFont.deriveFont(fontsize); makeHappen(con);
						 * return; } else { float fontsize = (float) sharedVariables.myFont.getSize();
						 * fontsize++; sharedVariables.myFont =
						 * sharedVariables.myFont.deriveFont(fontsize); makeHappen(con); return; } }
						 * 
						 * //if (a == 40) { if (a == KeyEvent.VK_DOWN) {
						 * 
						 * int con = sharedVariables.looking[consoleNumber];
						 * 
						 * if (sharedVariables.tabStuff[con].tabFont != null) { float fontsize = (float)
					...
					if (gme == InputEvent.ALT_DOWN_MASK) {
						/*
						 * //if (a == 39) { if (a == KeyEvent.VK_RIGHT) { int con =
						 * sharedVariables.looking[consoleNumber] + 1; if (con ==
						 * sharedVariables.maxConsoleTabs) con = 0; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3) {
						 * tabChooser.setSelectedIndex(con); } makeHappen(con); }
						 * 
						 * //if (a == 37) { if (a == KeyEvent.VK_LEFT) { int con =
						 * sharedVariables.looking[consoleNumber] - 1; if (con == -1) con =
						 * sharedVariables.maxConsoleTabs - 1; if
						 * (sharedVariables.consolesTabLayout[consoleNumber] == 3) {
						 * tabChooser.setSelectedIndex(con); } makeHappen(con); }
						 */
					}
						...
						if (sharedVariables.tabStuff[sharedVariables.looking[consoleNumber]].typed) {
							{
								...
								if (sharedVariables.tabStuff[sharedVariables.looking[consoleNumber]].typedColor == null) {
									StyleConstants.setForeground(attrs, sharedVariables.typedColor);
									writeToConsole(getAMinuteTimestamp() + " " + mes, sharedVariables.typedColor, true,
											attrs);
								} else {
									StyleConstants.setForeground(attrs,
											sharedVariables.tabStuff[sharedVariables.looking[consoleNumber]].typedColor);
									writeToConsole(getAMinuteTimestamp() + " " + mes,
											sharedVariables.tabStuff[sharedVariables.looking[consoleNumber]].typedColor,
											true, attrs);
								}
					...
					/*
					 * //if ((a == 120 || a == 119) && e.getModifiersEx() != 64) { if ((a ==
					 * KeyEvent.VK_F9 || a == KeyEvent.VK_F8) && (gme & InputEvent.SHIFT_DOWN_MASK)
					 * == 0) { String s = Input.getText(); String person; if (s.length() == 0)
					 * person = sharedVariables.F9Manager.getName(true); else person =
					 * sharedVariables.F9Manager.getName(false);
					 * 
					 * if (person.length() > 0) { Input.setText("/Tell " + person + "! ");
					 * Input.setForeground(sharedVariables.inputCommandColor); } }
					 * 
					 * //if ((a == 120 || a == 119) && e.getModifiersEx() == 64) { if ((a ==
					 * KeyEvent.VK_F9 || a == KeyEvent.VK_F8) && (gme & InputEvent.SHIFT_DOWN_MASK)
					 * != 0) { String s = Input.getText(); String person; if (s.length() == 0)
					 * person = sharedVariables.F9Manager.getNameReverse(true); else person =
					 * sharedVariables.F9Manager.getNameReverse(false);
					 * 
					 * if (person.length() > 0) { Input.setText("/Tell " + person + "! ");
					 * Input.setForeground(sharedVariables.inputCommandColor); } }
					 */
					if (a == KeyEvent.VK_F9 || a == KeyEvent.VK_F8) {
						...
						person = ((gme & InputEvent.SHIFT_DOWN_MASK) == 0
					...
					if ((gme & InputEvent.CTRL_DOWN_MASK) != 0 && a == KeyEvent.VK_UP && !Input.getText().equals("")) {
			...
			/*
			 * if (sharedVariables.consoleLayout==1) setMyLayout1(); else if
			 * (sharedVariables.consoleLayout==3) setMyLayout3(); else setMyLayout2();
			 */
			recreate(sharedVariables.consolesTabLayout[consoleNumber]);
		}
		/*
		 * // Andrey says: copied outside the class int getActiveGame() { int games =
		 * -1; for (int d=0; d<sharedVariables.maxGameTabs; d++) { if (myboards[d] ==
		 * null) break; if (myboards[d].isVisible()) { games = d; break; } } return
		 * games; }
		 * 
		 * void writeToConsole(String mes, Color col, boolean italic) { try {
		 * StyledDocument doc =
		 ...
		 * 
		 * StyleConstants.setForeground(styleQ, col);
		 * //StyleConstants.setUnderline(attrs, true); SimpleAttributeSet attrs = new
		 * SimpleAttributeSet();
		 * 
		 * if (italic) StyleConstants.setItalic(attrs, true);
		 * 
		 * StyleConstants.setForeground(attrs, col); int SUBFRAME_CONSOLES = 0; int
		 * maxLinks = 75; myoutput printOut = new myoutput(); printOut.processLink(doc,
		 * mes, col, sharedVariables.looking[consoleNumber], maxLinks,
		 * SUBFRAME_CONSOLES, attrs, null); queue.add(printOut);
		 * //doc.insertString(doc.getLength(), mes, attrs);
		 * 
		 * //for (int aa=0; aa<sharedVariables.maxConsoleTabs; aa++) // if
		 * (sharedVariables.looking[consoleNumber]==sharedVariables.looking[aa]) //
		 * consoles[aa].setStyledDocument(doc);
		 * 
		 * } catch (Exception E) {} }// end write to console
		 */
		...
		void setMyLayout1() {
			...
			h2.addComponent(sharedVariables.ConsoleScrollPane[consoleNumber], GroupLayout.DEFAULT_SIZE, 450,
					Short.MAX_VALUE);
			h2.addComponent(listScroller, sharedVariables.nameListSize, sharedVariables.nameListSize,
			...
			v2.addComponent(sharedVariables.ConsoleScrollPane[consoleNumber], GroupLayout.DEFAULT_SIZE, 233,
					Short.MAX_VALUE);
			v2.addComponent(listScroller);
			for (int a = 0; a < sharedVariables.maxConsoleTabs; a++)
				vmiddle.addComponent(channelTabs[a]);

			v1.addComponent(prefixHandler, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		...
		void setMyLayout2() {
			 ...
			 * middle2.addComponent(channelTabs[a],GroupLayout.DEFAULT_SIZE, 15,
			 * Short.MAX_VALUE);
		...
		void setMyLayout3() {
			...
			// Add a scroll pane and a label to the parallel group h2
			h2.addComponent(sharedVariables.ConsoleScrollPane[consoleNumber], GroupLayout.DEFAULT_SIZE, 50,
					Short.MAX_VALUE);
			h2.addComponent(listScroller, sharedVariables.nameListSize, sharedVariables.nameListSize,
					sharedVariables.nameListSize);
			...
			/*
			 * for (int a=0; a<sharedVariables.maxConsoleTabs; a++) {
			 * middle.addComponent(channelTabs[a],GroupLayout.DEFAULT_SIZE, 15,
			 * Short.MAX_VALUE);
			 * middle.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED); }
			...
			/*
			 * for (int a=0; a<sharedVariables.maxConsoleTabs; a++)
			 * vmiddle.addComponent(channelTabs[a]); vmiddle.addComponent(tellLabel);
			 * vmiddle.addComponent(tellCheckbox);
			 */
			v1.addComponent(tellCheckbox, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
					GroupLayout.PREFERRED_SIZE);
			v1.addComponent(tabChooser, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
					GroupLayout.PREFERRED_SIZE);
			v1.addComponent(prefixHandler, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
					GroupLayout.PREFERRED_SIZE);
			// v1.addComponent(scrollbutton);
...
/*
 * 
 * possible code to use to fix console not scrolling to bottom with new java 9
 * code
 * 
 * 
 * sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
 * addAdjustmentListener(new AdjustmentListener() { public void
 * adjustmentValueChanged(AdjustmentEvent e) { if (wheelIsScrolling) {
 * wheelIsScrolling = false; return; }
 * 
 * JScrollBar scrollBar = (JScrollBar) e.getSource(); BoundedRangeModel
 * listModel = scrollBar.getModel(); int value = listModel.getValue(); int
 * extent = listModel.getExtent(); int maximum = listModel.getMaximum(); if
 * (scrollnow == 1 &&
 * !sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
 * getValueIsAdjusting()) { //
 * e.getAdjustable().setValue(e.getAdjustable().getMaximum()); // end if not
 * adjusting value = maximum - extent; scrollBar.setValue(value -
 * consoles[consoleNumber].getFont().getSize()); } else { if
 * (sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
 * getValueIsAdjusting()) scrollnow = 0;
 * 
 * int d =
 * consoles[consoleNumber].getScrollableBlockIncrement(consoles[consoleNumber].
 * getVisibleRect(), SwingConstants.VERTICAL, -1); int myvalue = 60 + d; try {
 * if (sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
 * getValue() + myvalue >
 * sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
 * getMaximum()) scrollnow = 1;
 * 
 * if (scrollnow == 1 &&
 * !sharedVariables.ConsoleScrollPane[consoleNumber].getVerticalScrollBar().
 * getValueIsAdjusting())
 * e.getAdjustable().setValue(e.getAdjustable().getMaximum()); // value =
 * maximum - extent; //scrollBar.setValue(value -
 * consoles[consoleNumber].getFont().getSize()); // end try } catch (Exception
 * e1) {} }// end else }// end is adjustment value changed });// end adjustment
 * class
 * 
 */
