...
class CorrespondenceViewPanel extends JPanel// implements InternalFrameListener
{
	...
	void initComponents() {
		...
		// corrTable.removeColumn(corrTable.getColumnModel().getColumn(0)); will work to
		// remove game numbers
		...
		doubleClickHintLabel
				.setFont(new Font(doubleClickHintLabelFont.getName(), Font.PLAIN, doubleClickHintLabelFontSizeToUse));
		// System.out.println("font size is " +
		// doubleClickHintLabel.getFont().getSize());
		setLayout();
	...
	void setLayout() {
		...
		hRow2.addComponent(statusLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
		hRow2.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED);
		hRow2.addComponent(startGameButton, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
		...
		h1.addComponent(dummyLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE);
		h1.addGroup(hRow1);
		h1.addGroup(hRow2);
		h1.addGroup(hRow3);
		h1.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
		...
		vGroup.addComponent(dummyLabel, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
				GroupLayout.PREFERRED_SIZE);
		...
		vGroup.addComponent(scrollPane, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE);
		...
		MouseListener mouseListenerEvents = new MouseAdapter() {
			public void mousePressed(MouseEvent e) {
				if (e.getClickCount() == 2 && e.getButton() != MouseEvent.BUTTON3) {
					...
					String opponent = whiteName.toLowerCase().trim().equals(sharedVariables.whoAmI.toLowerCase().trim())
							? blackName
							: whiteName;
					...
					itemMove.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							CorrespondenceMoveDialog dialog = new CorrespondenceMoveDialog(homeFrame, sharedVariables,
									queue, gameIndex, whiteName + " vs " + blackName);
					...
					item3.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							updateStatusBar(
									"Abort offer sent or automatic on move one. Check Console M0 Tab for server feedback.");
						}
					});
					menu2.add(item3);
					...
					/*
					 * JMenuItem item5 = new JMenuItem("Delete Game"); item5.addActionListener(new
					 * ActionListener() { public void actionPerformed(ActionEvent e) {
					 * sendICSCommand("cc-delete #" + gameIndex); // need to clear data first
					 * Command("cc-list");
