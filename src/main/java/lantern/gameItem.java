...
class gameItem {
	...
	void addHistoryRow(String index, String whiteName, String blackName, String whiteRating, String blackRating,
			String date, String time, String whitetime, String whiteinc, String rated, String ratedType, String wild,
			String eco, String status, String color, String mode, tableClass myTable)

	{
		...
		/*
		 * Status is 0=win 1=draw 2=adjourned 3=abort. Color is 0=black 1=white, and is
		 * the side that lost (for status 0) or maybe acted.
		 */
...
// my rating my color vs opponent and opponetns rating.
	...
	void addSearchLiblistRow(String index, String whiteName, String blackName, String whiteRating, String blackRating,
			String date, String time, String whitetime, String whiteinc, String rated, String ratedType, String wild,
			String eco, String status, String color, String mode, String libnote, tableClass myTable)
...
// my rating my color vs opponent and opponetns rating.
		/*
		 * if(myName.equals(whiteName)) { String res = "";
		 * 
		 * if(status.equals("0")) {if(color.equals("0"))// white wins res="1-0"; else
		 * res="0-1"; }// end status 0
		 * 
		 * if(status.equals("1")) res="="; if(status.equals("3")) res="a"; data.add(res
		 * + " " + getGameEndCode(status, mode, color)); // result }// i'm white else {
		 */String res = "";
...
//}// i'm black
	...
	String getGameEndCode(String s, String m, String c) {
		...
		{
			/*
			 * mode 0: (?) Game adjourned by mutual agreement mode 1: (?) Game adjourned
			 * when Black disconnected mode 2: (?) Game adjourned by system shutdown mode 3:
			 * (?) Game courtesyadjourned by Black mode 4: (?) Game adjourned by an
			 * administrator mode 5: (?) Game adjourned when Black got disconnected
			 * 
			 */
			String dqcolor = "W";
			if (color == 0)
